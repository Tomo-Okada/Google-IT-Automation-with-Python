...
def process_data(data):
  ...
  for item in data:
    ...
    if item["car"]["car_year"] not in sales_year:
        sales_year[item["car"]["car_year"]] = item["total_sales"]
    else:
        sales_year[item["car"]["car_year"]] += item["total_sales"]
    if sales_year[item["car"]["car_year"]] > most_populer["total_sales"]:
        most_populer["car_year"] = item["car"]["car_year"]
        most_populer["total_sales"] = sales_year[item["car"]["car_year"]]
